...
- type: replace
  ...
  value: https://files.slack.com/files-pri/T02FL4A1X-F02E8ACDK34/download/pr-303-bosh-vsphere-cpi-68_dev.1.tgz?pub_secret=0b6f6bf02e
...
- type: replace
  ...
  value: 89985ac0b4828b5a10a7e2b704a4e812654ffcd8
" > tmp-cpi-ops.yml
